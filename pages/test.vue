<template>
  <section class="bg-gray-800 text-gray-100">
    <div
      class="container mx-auto max-w-xl space-y-24 p-6 py-12 lg:max-w-7xl lg:px-8"
    >
      <div>
        <h2
          class="text-center text-3xl font-bold tracking-tight text-gray-50 sm:text-5xl"
        >
          Aliquip definiebas ad est
        </h2>
        <p class="mx-auto mt-4 max-w-3xl text-center text-xl text-gray-400">
      ...
      <div class="grid lg:grid-cols-2 lg:items-center lg:gap-8">
        <div>
          <h3
            class="text-2xl font-bold tracking-tight text-gray-50 sm:text-3xl"
          >
          ...
          <div class="mt-12 space-y-12">
            <div class="flex">
              <div class="flex-shrink-0">
                <div
                  class="flex h-12 w-12 items-center justify-center rounded-md bg-violet-400 text-gray-900"
                >
                  <svg
      ...
      <div>
        <div class="grid lg:grid-cols-2 lg:items-center lg:gap-8">
          ...
          <div class="mt-10 lg:col-start-1 lg:row-start-1 lg:mt-0">
            <img
